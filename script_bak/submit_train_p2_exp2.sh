...
sbatch --partition=isi --gres=gpu:1 --time=120:00:00 --mem=64000 ./train_p2_exp2.sh P22 P1/EXP2 P10_M_nosig_C100_W300_MV0_EP51 ?? M nosig 100 300 ?? True 1
sbatch --partition=isi --gres=gpu:1 --time=120:00:00 --mem=64000 ./train_p2_exp2.sh P23 P1/EXP2 P10_M_nosig_C100_W300_MV0_EP51 ?? M nosig 100 300 ?? True 1
