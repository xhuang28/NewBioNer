...
# 1: idea; 2: pred method ("M", "U"); 3: sigmoid/nosigmoid; 4: char hidden size; 5: word hidden size; 6: mask value (please set 0 if idea!="Li");
EXEC_NAME="${1}_${2}_${3}_C${4}_W${5}_MV${6}_${7}"
...
python3 -u $SRC_FOLDER/train_p1.py \
  ...
  --batch_size 10 \
  --least_iters 50 --epoch 100 --patience 30 --stop_on_single \
  --lr 0.01 \
  --gpu 0 \
  --char_hidden $4 \
  --word_hidden $5 \
