...
sbatch --partition=isi --gres=gpu:1 --time=1:00:00 ./eval.sh P1 M 100_W300_MV0_0_EP200 N21_JNLPBA-IOBES_0.9012_0.8876_0.9153_63 pickle2
sbatch --partition=isi --gres=gpu:1 --time=1:00:00 ./eval.sh P1 M 100_W300_MV0_1_EP200 N21_BC4CHEMD-IOBES_0.9746_0.9688_0.9805_42 pickle2
sbatch --partition=isi --gres=gpu:1 --time=1:00:00 ./eval.sh P1 M 100_W300_MV1_1_EP200 N21_BC2GM-IOBES_0.8924_0.8322_0.9621_86 pickle2
