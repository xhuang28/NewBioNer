...
# 7: char hidden size; 8: word hidden size; 9: restart training; 10: index of train/dev combination
EXEC_NAME="${1}_${5}_${6}_C${7}_W${8}_Restart${9}_Comb${10}_IT${12}"
...
python3 -u $SRC_FOLDER/train_p3.py \
  ...
  --data_loader $SRC_FOLDER/data_loaders/$FOLDER/$CHECKPOINT_PATH.${12} \
