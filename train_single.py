...
if __name__ == "__main__":
    ...
    # For debugging
    # pickle.dump(args, open('/auto/nlg-05/huan183/NewBioNer/BP_args.p', 'wb'))
    # assert False
    # args = pickle.load(open('/auto/nlg-05/huan183/NewBioNer/BP_args.p', 'rb'))
    ...
    if not args.combine:
        ...
        trainer.train({0:crf2train_dataloader[0]+crf2dev_dataloader[0]}, crf2dev_dataloader, dev_dataset_loader, epoch_list, args)
